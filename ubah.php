...
<!--  <form action="" method="post" enctype="multipart/form-data"> wajib saat ingin membuat fitur upload -->
<form action="" method="post" enctype="multipart/form-data">
        <h1>mengubah data </h1>
        <input type="hidden" name="id" value="<?= $mhs["id"];?>">
        <!-- ini wajib agar memiliki mempunyai value -->
        ...
        <ul>
            ...
            <li>
                ...
                <img src="img/<?= $mhs["gambar"];?>" alt="2oowowooww"> <br>
